#Installing and laoding required packages
...
data<-read.csv("C:/Users/Ajay/PycharmProjects/Web_Scraping/Pre-cleaned-file.csv")
...
#Save file 
write.csv(data2,"C:/Users/Ajay/PycharmProjects/Web_Scraping/R-Cleaned-File.csv")
