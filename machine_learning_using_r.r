...
set.seed(123)
#Read the dataset
data<-read.csv("C:/Users/Ajay/PycharmProjects/Web_Scraping/Label-Encoded-data.csv",stringsAsFactors = FALSE,row.names =NULL)
...
#Adjusted R2 score of linear model
